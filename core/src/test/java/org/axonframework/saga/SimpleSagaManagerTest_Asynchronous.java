 ...
 */
public class SimpleSagaManagerTest_Asynchronous {
    ...
    public void setUp() throws Exception {
        ...
        testSubject = new SimpleSagaManager(Saga.class, repository, associationValueResolver, sagaFactory, eventBus,
                                            new DirectExecutor(), mockTransactionManager);
    ...
    public void testAllSagasAreInvoked() {
        ...
        verify(mockTransactionManager, times(3)).afterTransaction(isA(TransactionStatus.class));
        verify(mockTransactionManager, times(3)).beforeTransaction(isA(TransactionStatus.class));
    }
